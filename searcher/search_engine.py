...
def filter_shellcodes_with_comparator(shellcode, num_version, software_name, queryset):
    if not shellcode.description.__contains__('.x'):
        queryset = filter_shellcode_with_comparator_and_without_x(shellcode, num_version, software_name, queryset)
    else:
...
def filter_shellcode_with_comparator_and_without_x(shellcode, num_version, software_name, queryset):
...
def filter_exploits_with_comparator_and_x(shellcode, num_version, software_name, queryset):
